namespace tools {
    export class MapPositionCtrl extends CtrlBase<fairygui.GComponent>{
        public ui1: fuis.tools_0.UI_MapPosition;
        ...
        init() {
            this.ui1 = fuis.tools_0.UI_MapPosition.createInstance();
        ...
        hit(x: number, y: number): boolean {
            let rect: IRect = models.fights.FightModelUtil.gridSizeToRect(this.col, this.row, this.size);
            if (models.fights.FightModelUtil.hitXyRect(x,y,rect)){
                return true;
            }
            return false;
