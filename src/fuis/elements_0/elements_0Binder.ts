...
module fuis.elements_0 {
	...
	export class elements_0Binder{
		public static bindAll():void {
			fairygui.UIObjectFactory.setPackageItemExtension(UI_MapFloor.URL, UI_MapFloor);
			fairygui.UIObjectFactory.setPackageItemExtension(UI_Crack.URL, UI_Crack);
			fairygui.UIObjectFactory.setPackageItemExtension(UI_ScaleBar.URL, UI_ScaleBar);
