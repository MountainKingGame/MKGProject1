...
module fuis.joysticks_1 {
	...
	export class UI_JoystickComp extends fairygui.GComponent {
		...
		protected constructFromXML(xml: any): void {
			...
			this.m_joystick = <UI_JoystickButton><any>(this.getChildAt(3));
